...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        PasswdlineEdit->setGeometry(QRect(210, 170, 191, 31));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        UserlineEdit->setText(QApplication::translate("Widget", "xaf", Q_NULLPTR));
        PasswdlineEdit->setText(QApplication::translate("Widget", "xaf", Q_NULLPTR));
